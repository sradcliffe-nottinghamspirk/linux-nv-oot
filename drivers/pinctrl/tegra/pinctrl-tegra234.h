...
/* This file is copy version of pinctrl-tegra.h available in the downstream kernel
   which is common across the Tegra pincontrol driver. As this header is internal header
   and not available for development of module, making the duplicate of the header for
   module driver development.
*/

#ifndef __PINCTRL_TEGRA234_H__
#define __PINCTRL_TEGRA234_H__
